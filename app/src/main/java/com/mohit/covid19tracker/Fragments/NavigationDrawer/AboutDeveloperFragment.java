package com.mohit.covid19tracker.Fragments.NavigationDrawer;
...
public class AboutDeveloperFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fb.setOnClickListener(v-> {
                try {
                    startActivity(new Intent(Intent.ACTION_VIEW,
                            Uri.parse("https://www.facebook.com/100002695450720")));
        ...
        insta.setOnClickListener(v-> {
                try {
                    startActivity(new Intent(Intent.ACTION_VIEW,
                            Uri.parse("https://www.instagram.com/mohitgoel_9/")));
                } catch (ActivityNotFoundException e) {
                }
        });
        ...
        linkedin.setOnClickListener(v-> {
                try {
                    startActivity(new Intent(Intent.ACTION_VIEW,
                            Uri.parse("https://www.linkedin.com/in/mohit-9")));
                } catch (ActivityNotFoundException e) {
                }
        });
        ...
        gmail.setOnClickListener(v-> {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL,new String[] {"mohitgoel_2k18co206@dtu.ac.in"});
